const projects = [
  { number: '01', type: 'web', tag: 'JavaScript / PBO', title: 'Tugas Akhir PBO', description: 'Eksplorasi pemrograman berorientasi objek dengan JavaScript.', tech: 'JavaScript, PBO, Git', problem: 'Menerapkan konsep PBO ke dalam proyek JavaScript yang terstruktur.', process: 'Memetakan objek, merancang class, lalu menguji interaksi antar komponen.', result: 'Fondasi aplikasi yang lebih modular dan mudah dikembangkan.', link: 'https://github.com/ferdiansyah-zdn/Tugas-akhir-166_Zidane-ferdiansyah.git', visual: 'oop', visualLabel: 'OBJECT\nORIENTED' },
  { number: '02', type: 'web', tag: 'Laravel / Web Profile', title: 'Dimsum Date', description: 'Website profil untuk brand kuliner dengan pengalaman yang hangat.', tech: 'Laravel, PHP, Blade, CSS', problem: 'Menyampaikan identitas brand kuliner secara informatif dan menarik.', process: 'Menyusun struktur informasi, mengembangkan halaman, lalu menyempurnakan responsivitas.', result: 'Website profil yang jelas, hangat, dan siap dijelajahi pelanggan.', link: 'https://github.com/ferdiansyah-zdn/Web-Profile-Dimsum-Date.git', visual: 'dimsum', visualLabel: 'DIMSUM\nDATE' },
